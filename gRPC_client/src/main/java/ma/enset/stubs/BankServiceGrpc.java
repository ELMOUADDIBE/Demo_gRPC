...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ma.enset.stubs.Ebank.ConvertCurrencyRequest,
      ma.enset.stubs.Ebank.ConvertCurrencyResponse> getConvertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "convert",
      requestType = ma.enset.stubs.Ebank.ConvertCurrencyRequest.class,
      responseType = ma.enset.stubs.Ebank.ConvertCurrencyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ma.enset.stubs.Ebank.ConvertCurrencyRequest,
      ma.enset.stubs.Ebank.ConvertCurrencyResponse> getConvertMethod() {
    io.grpc.MethodDescriptor<ma.enset.stubs.Ebank.ConvertCurrencyRequest, ma.enset.stubs.Ebank.ConvertCurrencyResponse> getConvertMethod;
    if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
          BankServiceGrpc.getConvertMethod = getConvertMethod = 
              io.grpc.MethodDescriptor.<ma.enset.stubs.Ebank.ConvertCurrencyRequest, ma.enset.stubs.Ebank.ConvertCurrencyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "BankService", "convert"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.enset.stubs.Ebank.ConvertCurrencyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.enset.stubs.Ebank.ConvertCurrencyResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ma.enset.stubs.Ebank.ConvertCurrencyRequest,
      ma.enset.stubs.Ebank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.enset.stubs.Ebank.ConvertCurrencyRequest,
      ma.enset.stubs.Ebank.ConvertCurrencyResponse> getPerformStreamMethod() {
    io.grpc.MethodDescriptor<ma.enset.stubs.Ebank.ConvertCurrencyRequest, ma.enset.stubs.Ebank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<ma.enset.stubs.Ebank.ConvertCurrencyRequest,
      ma.enset.stubs.Ebank.ConvertCurrencyResponse> getGetStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.enset.stubs.Ebank.ConvertCurrencyRequest,
      ma.enset.stubs.Ebank.ConvertCurrencyResponse> getGetStreamMethod() {
    io.grpc.MethodDescriptor<ma.enset.stubs.Ebank.ConvertCurrencyRequest, ma.enset.stubs.Ebank.ConvertCurrencyResponse> getGetStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<ma.enset.stubs.Ebank.ConvertCurrencyRequest,
      ma.enset.stubs.Ebank.ConvertCurrencyResponse> getFullStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.enset.stubs.Ebank.ConvertCurrencyRequest,
      ma.enset.stubs.Ebank.ConvertCurrencyResponse> getFullStreamMethod() {
    io.grpc.MethodDescriptor<ma.enset.stubs.Ebank.ConvertCurrencyRequest, ma.enset.stubs.Ebank.ConvertCurrencyResponse> getFullStreamMethod;
  ...
  public static abstract class BankServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void convert(ma.enset.stubs.Ebank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<ma.enset.stubs.Ebank.ConvertCurrencyResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getConvertMethod(), responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<ma.enset.stubs.Ebank.ConvertCurrencyRequest> performStream(
        io.grpc.stub.StreamObserver<ma.enset.stubs.Ebank.ConvertCurrencyResponse> responseObserver) {
    ...
    /**
     */
    public void getStream(ma.enset.stubs.Ebank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<ma.enset.stubs.Ebank.ConvertCurrencyResponse> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<ma.enset.stubs.Ebank.ConvertCurrencyRequest> fullStream(
        io.grpc.stub.StreamObserver<ma.enset.stubs.Ebank.ConvertCurrencyResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ma.enset.stubs.Ebank.ConvertCurrencyRequest,
                ma.enset.stubs.Ebank.ConvertCurrencyResponse>(
  ...
  public static final class BankServiceBlockingStub extends io.grpc.stub.AbstractStub<BankServiceBlockingStub> {
    ...
    /**
     */
    public ma.enset.stubs.Ebank.ConvertCurrencyResponse convert(ma.enset.stubs.Ebank.ConvertCurrencyRequest request) {
    ...
    /**
     */
    public java.util.Iterator<ma.enset.stubs.Ebank.ConvertCurrencyResponse> getStream(
        ma.enset.stubs.Ebank.ConvertCurrencyRequest request) {
  ...
  public static final class BankServiceFutureStub extends io.grpc.stub.AbstractStub<BankServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ma.enset.stubs.Ebank.ConvertCurrencyResponse> convert(
        ma.enset.stubs.Ebank.ConvertCurrencyRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONVERT:
          serviceImpl.convert((ma.enset.stubs.Ebank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<ma.enset.stubs.Ebank.ConvertCurrencyResponse>) responseObserver);
          break;
        case METHODID_GET_STREAM:
          serviceImpl.getStream((ma.enset.stubs.Ebank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<ma.enset.stubs.Ebank.ConvertCurrencyResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ma.enset.stubs.Ebank.getDescriptor();
    }
